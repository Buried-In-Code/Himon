...
def test_optional_int_str() -> None:
    """Test converting a str to an Optional[int]."""
    output = to_optional_int("12")
    assert output == 12


def test_optional_int_zero() -> None:
